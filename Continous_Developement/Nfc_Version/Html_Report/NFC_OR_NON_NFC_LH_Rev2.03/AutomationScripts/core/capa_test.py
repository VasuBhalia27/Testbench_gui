...
class CapaTest:
    ...
    def run_tc_capa_01(self) -> Dict:
        ...
        while True:
            ...
            # Retry until all sensor values are in the active range (sensors_active)
            # or the deadline is reached — do NOT exit early just because values
            # are non-None; a below-threshold reading must trigger another DID.
