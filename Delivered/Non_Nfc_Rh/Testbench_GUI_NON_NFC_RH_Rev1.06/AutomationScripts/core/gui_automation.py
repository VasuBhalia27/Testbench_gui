...
class AutomationGUI:
    def __init__(self, parent_widget=None, lock_callback=None, unlock_callback=None):
        ...
        if parent_widget is None:
            ...
            self.root = tk.Tk()
            self.root.title("Non-NFC RH Rev 1.06 Automation")
    ...
    def _build_ui(self, container):
        ...
        # Welcome header
        header = ttk.Label(right_panel, text="Non-NFC RH Rev 1.06 Automation",
                           font=(None, 16, "bold"))
        header.pack(pady=(10, 4))

        welcome = ttk.Label(right_panel,
                            text="Welcome to Non-NFC RH Rev 1.06 Automation\n"
