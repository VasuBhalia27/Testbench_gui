...
canvas2.create_text(61.0, 144.0, anchor="nw", text="Connect to Power Supply -->", fill="#000000", font=("Inter SemiBold", 15 * -1))
canvas2.create_text(61.0, 207.0, anchor="nw", text="Power ON -->", fill="#000000", font=("Inter SemiBold", 15 * -1))
canvas2.create_text(61.0, 263.0, anchor="nw", text="Power OFF -->", fill="#000000", font=("Inter SemiBold", 15 * -1))
canvas2.create_text(61.0, 319.0, anchor="nw", text="Connect to Trace32 --> ", fill="#000000", font=("Inter SemiBold", 15 * -1))
canvas2.create_text(61.0, 375.0, anchor="nw", text="Disconnect to Trace32 --> ", fill="#000000", font=("Inter SemiBold", 15 * -1))
canvas2.create_text(61.0, 431.0, anchor="nw", text="Select BMW Repository:  ", fill="#000000", font=("Inter SemiBold", 15 * -1))
canvas2.create_text(61.0, 600.0, anchor="nw", text="Note: Make sure ELF for the selected preset is generated  ", fill="#FF0000", font=("Inter SemiBold", 11 * -1))
...
tab3_run_btn = Button(tab3, image=images["tab3_led_run"],
                        ...
                        bd = 0)
tab3_run_btn.place(x=368, y=106, width=34, height=34)
# ===================================================================================================================
# ===================================================================================================================
...
tab4_run_btn = Button(tab4, image=images["tab4_motor_run"],
                        ...
                        bd = 0)
tab4_run_btn.place(x=368, y=106, width=34, height=34)
...
# Entries
canvas5.create_text(73.0, 113.0, anchor="nw", text="Motor Test Results (DID 103)", fill="#000000", font=("Inter SemiBold", 20 * -1))
canvas5.create_text(73.0, placement_y_coord+35, anchor="nw", text="MotorCoupledVoltage", fill="#000000", font=("Inter SemiBold", 15 * -1))
...
canvas5.create_text(73.0, placement_y_coord + 35*2, anchor="nw", text="MotorDecoupledVoltage", fill="#000000", font=("Inter SemiBold", 15 * -1))
...
canvas5.create_text(73.0, placement_y_coord + 35*3, anchor="nw", text="MotorCurrentValue", fill="#000000", font=("Inter SemiBold", 15 * -1))
...
canvas5.create_text(73.0, placement_y_coord + 35*4, anchor="nw", text="MotorLoadError", fill="#000000", font=("Inter SemiBold", 15 * -1))
...
canvas6.create_text(73.0, placement_y_coord+35, anchor="nw", text="TestFw_EosDiagVoltage", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab6_entry1 = ttk.Entry(tab6_frame, style = 'Background_grey.TEntry')
tab6_entry1.place(x=306, y=placement_y_coord+35, width=95.0, height=20.0)

canvas6.create_text(73.0, placement_y_coord + 35*2, anchor="nw", text="TestFw_EosPinState", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab6_entry2 = ttk.Entry(tab6_frame, style = 'Background_grey.TEntry')
tab6_entry2.place(x=306, y=placement_y_coord + 35*2, width=95.0, height=20.0)

canvas6.create_text(73.0, placement_y_coord + 35*3, anchor="nw", text="TestFw_EosErrorsWithLow", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab6_entry3 = ttk.Entry(tab6_frame, style = 'Background_grey.TEntry')
tab6_entry3.place(x=306, y=placement_y_coord + 35*3, width=95.0, height=20.0)

canvas6.create_text(73.0, placement_y_coord + 35*4, anchor="nw", text="TestFw_EosErrorsWithHigh", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab6_entry4 = ttk.Entry(tab6_frame, style = 'Background_grey.TEntry')
tab6_entry4.place(x=306, y=placement_y_coord + 35*4, width=95.0, height=20.0)
...
tab6_run_btn.place(x=368, y=106, width=34, height=34)
...
# Entries
canvas7.create_text(34.0, 75.0, anchor="nw", text="Sg Test Outputs (DID 106)", fill="#000000", font=("Inter SemiBold", 20 * -1))

canvas7.create_text(34.0, offset_top + 0*40, anchor="nw",text="DoPwrSg", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 1*40, anchor="nw",text="Sg1PlusOpamp", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 2*40, anchor="nw",text="Sg1MinusOpamp", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 3*40, anchor="nw",text="Sg1Opamp", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 4*40, anchor="nw",text="Sg1Dac", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 5*40, anchor="nw",text="Sg2PlusOpamp", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 6*40, anchor="nw",text="Sg2MinusOpamp", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 7*40, anchor="nw",text="Sg2Opamp", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
canvas7.create_text(34.0, offset_top + 8*40, anchor="nw",text="Sg2Dac", fill="#000000", font=("Inter SemiBold", 12 * -1))
...
# Entries
canvas8.create_text(73.0, 113.0, anchor="nw", text="Capa Test Outputs (DID 106)", fill="#000000", font=("Inter SemiBold", 20 * -1))
canvas8.create_text(73.0, 168.0, anchor="nw", text="CapaApproach", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab8_entry_1 = ttk.Entry(tab8_frame, style ='Background_grey.TEntry')
tab8_entry_1.place(x=350.0, y=168.0, width=95.0, height=20.0)

canvas8.create_text(73.0, 214.0, anchor="nw", text="CapaLock", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab8_entry_2 = ttk.Entry(tab8_frame, style = 'Background_grey.TEntry')
tab8_entry_2.place(x=350.0, y=214.0, width=95.0, height=20.0)

canvas8.create_text(73.0, 260.0, anchor="nw", text="CapaUnlock", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab8_entry3 = ttk.Entry(tab8_frame, style = 'Background_grey.TEntry')
tab8_entry3.place(x=350.0, y=260.0, width=95.0, height=20.0)

canvas8.create_text(73.0, 306.0, anchor="nw", text="CapaApproachSensorValue", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab8_entry4 = ttk.Entry(tab8_frame, style = 'Background_grey.TEntry')
tab8_entry4.place(x=350.0, y=306.0, width=95.0, height=20.0)

canvas8.create_text(73.0, 352.0, anchor="nw", text="CapaLockSensorValue", fill="#000000", font=("Inter SemiBold", 15 * -1))
tab8_entry5 = ttk.Entry(tab8_frame, style = 'Background_grey.TEntry')
tab8_entry5.place(x=350.0, y=352.0, width=95.0, height=20.0)

canvas8.create_text(73.0, 398.0, anchor="nw", text="CapaUnlockSensorValue", fill="#000000", font=("Inter SemiBold", 15 * -1))
...
tab9_run_btn.place(x=368, y=106, width=34, height=34)
...
tab11_run_btn.place(x=368, y=106, width=34, height=34)
